...
export const bookCar = (reqobj) => async (dispatch) => {
  ...
  try {
    const response = await axios.post('https://jysan-wheels-car-rental-backend-3.onrender.com/api/bookings/bookcar', reqobj);
...
export const getAllBookings = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get('https://jysan-wheels-car-rental-backend-3.onrender.com/api/bookings/getallbookings');
